...
class CreateVanillaIngredientMenu(isEdit: Boolean, nowItem: ItemStack? = null, nowName: String? = null) : AbstractCreateIngredientMenu("CreateVanillaIngredient", isEdit, nowItem, nowName) {
