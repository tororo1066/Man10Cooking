...
class CreateUniqueIngredientMenu(isEdit: Boolean, nowItem: ItemStack? = null, nowName: String? = null) : AbstractCreateIngredientMenu("CreateUniqueIngredient", isEdit, nowItem, nowName) {
